...
export default function ContaPersonal() {
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <main className="container" style={{ padding: 24 }}>
        ...
        <SubscriptionStatusCard
          profile={profile}
          billing={billing}
          manageReturnPath="/dashboard/personal/conta"
        />
        {profile?.plan !== 'PREMIUM' && (
          <div style={{ marginTop: 24 }}>
            <UpgradeCard
              offeredPlan="PERSONAL"
              returnBasePath="/dashboard/personal"
              title="Assinar Premium Personal"
              description="IA para treinos e recursos para profissionais."
            />
          </div>
        )}
      </main>
